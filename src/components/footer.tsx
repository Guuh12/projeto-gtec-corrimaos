      ...
      <div className="container mx-auto px-4">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
          ...
          <div>
            ...
            <div className="text-sm text-secondary-foreground flex items-center mb-2">
          ...
          <div>
            ...
            <div className="text-sm text-secondary-foreground flex items-start mb-2">
              <MapPin className="h-4 w-4 mr-2 text-primary" />
              <span>R. Manoel Ribas, 15 - Vila Jussara, Carapicuíba - SP, 06321-190</span>
            </div>
            <div className="text-sm text-secondary-foreground flex items-center">
        ...
        {/* Bottom Bar */}
        <div className="flex justify-between items-center mt-8 pt-4 border-t border-secondary-foreground/20">
          <p className="text-sm text-secondary-foreground">
